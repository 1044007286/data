...
DEFFLD = {
    ...
    item_radio: '<li><input name="CHKED" value="1" class="radio" type="radio" title="默认选中此择项" /><input name="VAL" type="text" class="xs"/><a class="icononly-add iconfont icon-pos" title="添加一个新的选择项">&#xe60b;</a><a class="icononly-del iconfont icon-pos" title="删除此选择项">&#xe619;</a><a class="icononly-mov iconfont icon-pos" title="排序">&#xe63d;</li>',
...
function saveForm(e, f, c) {
    ...
    var dataupdate=$('.dataupdate').attr('href')

    storage.setItem('frm_area',$('[data="frm-area"]').html());
    storage.setItem('frm_area',$('[data="config-area"]').html());

    // console.log($('[data="frm-area"]').html());
    // console.log($('[data="config-area"]').html());
