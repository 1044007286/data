...
DEFFLD = {
    ...
    phone: {
        html: '<label class="desc"><span class="req hide"> *</span></label><div class="content oneline reduction"><input type="phone"  maxlength="32" class="s input fld" /> <button type="button" class="btn sendcode hide">发送验证码</button></div>'
    },
