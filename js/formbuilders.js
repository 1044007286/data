...
var datatitle = $('input[name=datatitle]').val()
var datacontent = $('.datacontent').html()
var conhtml = $('.conhtml').html()
storage.setItem('m',datatitle);
storage.setItem('f',datacontent);
    var M= JSON.parse(datatitle)
    var F = JSON.parse(datacontent)
var fieldsLimit=150;
var goodsNumber=60;
var imageNumber=10;
var LVL=4;
...
DEFFLD = {
    ...
    item_radio: '<li><input name="CHKED" value="1" class="radio" type="radio" title="默认选中此择项" /><input name="VAL" type="text" class="xs"/><a class="icononly-add iconfont icon-pos" title="添加一个新的选择项">&#xe60b;</a><a class="icononly-del iconfont icon-pos" title="删除此选择项">&#xe619;</a><a class="icononly-mov iconfont icon-pos" title="排序">&#xe63d;</a></li>',
    item_dropdown: '<li><input name="CHKED" value="1" class="radio" type="radio" title="默认选中此择项" /><input name="VAL" type="text" class="sl"/><a class="icononly-add iconfont" title="添加一个新的选择项">&#xe60b;</a><a class="icononly-del iconfont" title="删除此选择项">&#xe619;</a><a class="icononly-mov iconfont" title="排序">&#xe63d;</a></li>',
    ...
    date: {
        html: '<label class="desc">日期 <span class="req hide"> *</span></label><div class="content oneline reduction"><span class="sinput">\t<input class="yyyy input" disabled="disabled" maxlength="4" type="text"/>\t<label>YYYY</label></span><span class="split"> - </span><span class="sinput">\t<input class="mm input" disabled="disabled" maxlength="2" type="text"/>\t<label>MM</label></span><span class="split"> - </span><span class="sinput">\t<input class="dd input" disabled="disabled" maxlength="2" type="text"/>\t<label>DD</label></span><span><a class="icononly-date" title="选择日期"></a></span></div>',
    ...
    date_ymd: '<span class="sinput"><input class="yyyy input" disabled="disabled" maxlength="4" type="text"/><label>YYYY</label></span><span class="split"> - </span><span class="sinput"><input class="mm input" disabled="disabled" maxlength="2" type="text"/><label>MM</label></span><span class="split"> - </span><span class="sinput"><input class="dd input" disabled="disabled" maxlength="2" type="text"/><label>DD</label></span><span><a class="icononly-date" title="选择日期"></a></span>',
    date_mdy: '<span class="sinput"><input class="mm input" disabled="disabled" maxlength="2" type="text"/><label>MM</label></span><span class="split"> / </span><span class="sinput"><input class="dd input" disabled="disabled" maxlength="2" type="text"/><label>DD</label></span><span class="split"> / </span><span class="sinput"><input class="yyyy input" disabled="disabled" maxlength="4" type="text"/><label>YYYY</label></span><span><a class="icononly-date" title="选择日期"></a></span>',
    date_dmy: '<span class="sinput"><input class="dd input" disabled="disabled" maxlength="2" type="text"/>\t<label>DD</label></span><span class="split"> / </span><span class="sinput">\t<input class="mm input" disabled="disabled" maxlength="2" type="text"/>\t<label>MM</label></span><span class="split"> / </span><span class="sinput">\t<input class="yyyy input" disabled="disabled" maxlength="4" type="text"/>\t<label>YYYY</label></span><span><a class="icononly-date" title="选择日期"></a></span>',
    time: {
...
function fieldInit() {
    ...
    $('li.field', '#fields').live({
        ...
        click: function () {
            ...
            $(this).find('i.move').addClass('hide')
            $(this).find('div.fieldActions').removeClass('hide');
        }
    })
}
...
function saveForm(e, f, c) {
    ...
    $('input[name=title]').val(JSON.stringify(M))
    $('input[name=content]').val(JSON.stringify(F))
    $('input[name=conhtml]').val(JSON.stringify($('[data="frm-area"]').html()))
    $('#submit').click()
...
function initWangEditor() {
    ...
    htmlEditor.onchange = function () {
        $('#html').val(this.$txt.text()).trigger('change')
    };
    descEditor.onchange = function () {
        $('#desc').val(this.$txt.text()).trigger('change')
    };
    secdescEditor.onchange = function () {
        $('#secdesc').val(this.$txt.text()).trigger('change')
    };
    htmlEditor.create();
    descEditor.create();
